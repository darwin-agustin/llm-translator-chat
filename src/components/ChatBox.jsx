...
export default function ChatBox({ messages, isTranslating }) {
      ...
      {messages.map((msg, idx) => {
        ...
        return (
          ...
          >
            ...
            <div 
              className={`max-w-[85%] md:max-w-[75%] px-5 py-3.5 rounded-2xl shadow-sm text-[15px] md:text-base leading-relaxed ${
                isUser 
